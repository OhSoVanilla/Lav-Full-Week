...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'lav':
				frames = Paths.getSparrowAtlas('lav/LavPhase1');
			...
			case 'lavtired':
				frames = Paths.getSparrowAtlas('lav/LavPhase2');
				animation.addByPrefix('idle', "LavTiredIdleFinal", 24, false);
				animation.addByPrefix('singUP', "LavTiredUpFinal", 24, false);
				animation.addByPrefix('singDOWN', "LavTiredDownFinal",  24, false);
				animation.addByPrefix('singLEFT', "LavTiredLeftFinal", 24, false);
				animation.addByPrefix('singRIGHT', "LavTiredRightFinal", 24, false);
			...
			case 'lavfinal':
				...
				addOffset('idle');
				addOffset("singUP");
				addOffset("singRIGHT", 70, -30);
				addOffset("singLEFT", -150, 0);
				addOffset("singDOWN", 0, 10);
				
				playAnim('idle');
			case 'lavnobp':
				frames = Paths.getSparrowAtlas('lav/LavNoBP');
				animation.addByPrefix('idle', "LavIdleNoBP", 24, false);
				animation.addByPrefix('singUP', "LavUpNoBP", 24, false);
				animation.addByPrefix('singDOWN', "LavDownNoBP",  24, false);
				animation.addByPrefix('singLEFT', "LavLeftNoBP", 24, false);
				animation.addByPrefix('singRIGHT', "LavRightNoBP", 24, false);
	...
	override function update(elapsed:Float)
	{
		...
		switch (curCharacter)
		{
			...
			case 'lavtired':
				...
				{
					case (1):
						frames = Paths.getSparrowAtlas('lav/LavMidSongEvent');
						animation.addByPrefix('bp', "LavMidSongEvent", 15, false);
	...
	public function playAnim(AnimName:String, Force:Bool = false, Reversed:Bool = false, Frame:Int = 0):Void
	{
		...
		if (curCharacter == 'lavfinal')
		{
			if (animOffsets.exists(AnimName))
			{
				offset.set(frameWidth / 2 + daOffset[0], frameHeight / 2 + daOffset[1]);
			}
			else
