...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		credTextShit = new Alphabet(0, 0, "ohsovanilla\nseanothing", true);
	...
	override function beatHit()
	{
		...
		if (curBeat % 2 == 1)
			gfDance.animation.play('loop', true);
		...
		{
			case 1:
				createCoolText(['ohsovanilla', 'seanothing', 'rigormarcy', 'srperez']);
			...
			case 5:
				if (Main.watermarks)
					createCoolText(['I', 'love']);
				else
					createCoolText(['In Partnership', 'with']);
			case 7:
				if (Main.watermarks)
					addMoreText('Sarvente');
				else
				{
